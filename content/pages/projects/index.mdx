...
You can find the repo here: [Github Repo](https://github.com/Liam-So/4AM_basketball). The website can be found at: (currently being deployed, will update domain is finalized)
...
However, with new restrictions due to Covid-19, time-slots have become increasingly difficult to book as there limited spots.
...
I created this bot to benefit myself, my peers, and also to anyone who would like to use it.
Being open-source, anyone is free to use this code and make changes to their liking.
My goal is for people to find it useful in some way. You can find the repo here: [Github Repo](https://github.com/ryan-hong/Fit4Less-Bot)
